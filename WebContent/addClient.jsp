                                  ...
                                  <div class="page-breadcrumb">
                                      <nav aria-label="breadcrumb">
                                          <ol class="breadcrumb">
                                              ...
                                              <li class="breadcrumb-item active" aria-current="page">Añadir Clientes</li>
                                                </li>
                                   ...
                                   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                       <div class="card">
                                                   ...
                                                   <div class="row">
                                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                          <div class="content-inside">
                                                                      <div id="tabla-Create_client">
      
                                          <h2>Añadir nuevo Registro</h2>
                                          <form action="CreateCServlet" method="post">
                                          <p>
                                                 <label for="txtCliente">Id Cliente: </label>
                                                 <input id="txtCliente" type="text" name="txtCliente">
                                          </p>
                                          <p>
                                          ...
                                          <p>
                                                 ...
                                                 <input id="txtDomicilio" type="text" name="txtDomicilio">
                                          </p>
                                          <p>
                                          ...
                                          <p>
     		                                   <button type="button" id="btnCrearC">Crear Cliente</button>
	                                   </p>
                                   </form>
                                 <hr>
...
<script type="text/javascript" src="scripts/script2C.js"></script>
</body>
</html>