                                  ...
                                  <div class="page-breadcrumb">
                                      <nav aria-label="breadcrumb">
                                          <ol class="breadcrumb">
                                              ...
                                              <li class="breadcrumb-item active" aria-current="page">Actualizar Clientes</li>
                                                </li>
...
<form action="UpdateCServlet" method="post">
     ...
     <p>
     		<button type="button" id="btnActualizarC">Actualizar Cliente</button>
	 </p>
</form>
<hr>
...
<script type="text/javascript" src="scripts/script3C.js"></script>
</body>
</html>