                                  ...
                                  <div class="page-breadcrumb">
                                      <nav aria-label="breadcrumb">
                                          <ol class="breadcrumb">
                                              ...
                                              <li class="breadcrumb-item active" aria-current="page">Eliminar Clientes</li>
                                                </li>
                                                   ...
                                                   <div class="row">
                                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                          <div class="content-inside">
                                                                      <div id="delete-Clients">

                                                 <h2>Borrar un cliente</h2>
                                                 <form action="DeleteCServlet" method="post">
                                                 <p>
                                                        <label for="txtIdCliente">Id Cliente: </label>
                                                        <input id="txtIdCliente" type="text" name="txtIdCliente">
                                                 </p>
                                                 <p>
                                                               <button type="button" id="btnBorrarC">Borrar el registro</button>
                                                        </p>
                                                 </form>
                                                 <hr>
...
<script type="text/javascript" src="scripts/script4C.js"></script>
</body>
</html>