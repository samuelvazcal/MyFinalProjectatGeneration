                                  ...
                                  <div class="page-breadcrumb">
                                      <nav aria-label="breadcrumb">
                                          <ol class="breadcrumb">
                                              ...
                                              <li class="breadcrumb-item active" aria-current="page">Mostrar Clientes</li>
                                                </li>
                                                   ...
                                                   <div class="row">
                                                         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                          <div class="content-inside">
                                                                      <div id="tabla-Show_client">

<h2>Buscar un cliente</h2>
<form action="ReadServletC_I" method="post">
      <p>
            <label for="txtIdCliente">Id Cliente:</label>
            <input id="txtIdCliente" type="text" name="txtIdCliente">
     </p>
     <p>
     		<button type="button" id="btnCBuscar_I">Buscar Cliente</button>
	 </p>
</form>
<hr>
<h2>Buscar todos los clientes</h2>
<form action="ReadCServlet_A" method="post">
     <p>
			<button type="button" id="btnCBuscar_A">Mostar todos los Clientes</button>
	 </p>
</form>
<hr>
...
<script type="text/javascript" src="scripts/script1C.js"></script>
</body>
</html>